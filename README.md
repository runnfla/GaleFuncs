...
1\. Download the corresponding `.oxt` file from the [Add-In](https://github.com/runnfla/StElmoFire/tree/main/Add-In/LibreOffice%20Calc) directory\
...
1\. Download the `StElmoFire Excel.zip` archive from the [Add-In](https://github.com/runnfla/StElmoFire/tree/main/Add-In/MS%20Excel) directory\
2\. Extract files from the ZIP archive to a convenient and permanent folder on your computer (e.g., `C:\StElmoFire\`)\
...
7\. In the **Add-Ins** dialog box, click **Browse**, select the extracted `StElmoFire Excel.xlam` file and click **OK**\
8\. Make sure that the **StElmoFire Excel** add-in appears in the list and is checked and click **OK**
...
3 |   2.2     |     mV       |   0.1`kOhm`  | =ELMOSTR("U", A3, "UX", B3, "R", C3, $E$2) |                          |
  +-----------+--------------+--------------+--------------------------------------------+--------------------------+
```
For details on the RunFormula syntax, refer to [Help/Eng/runflahelp-eng.txt](https://github.com/runnfla/StElmoFire/blob/main/Help/Eng/runflahelp-eng.txt) ([Help/Rus/runflahelp.txt](https://github.com/runnfla/StElmoFire/blob/main/Help/Rus/runflahelp.txt) in Russian).
